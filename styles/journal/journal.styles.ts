...
export const journalFormStyles = StyleSheet.create({
  ...
  moodCard:   { paddingVertical: 12, paddingHorizontal: 16, overflow: 'hidden' },
  moodRow:    { flexDirection: 'row', alignItems: 'center', gap: 10, minHeight: 46 },
  moodIconWrap: {
    width: 46,
    height: 46,
    borderRadius: 23,
  ...
  moodEmoji:  { fontSize: 30, lineHeight: 38, width: 46, textAlign: 'center' },
  moodPlaceholder: { fontFamily: 'Nunito_700Bold', fontSize: 18, color: J.placeholder },
  moodName:   { fontFamily: 'Nunito_700Bold', fontSize: 15, color: J.textPrimary },
  moodDesc:   { fontFamily: 'Nunito_400Regular', fontSize: 12, color: J.textMuted, marginTop: 2 },
  moodChange: { fontFamily: 'Nunito_600SemiBold', fontSize: 13, color: J.accent, flexShrink: 0 },
  moodChevron:{ fontSize: 22, color: J.placeholder, flexShrink: 0 },
  moodTextWrap: { flex: 1, minWidth: 0 },
